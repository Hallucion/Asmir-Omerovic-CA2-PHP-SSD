...
-- DATA [PAIN RELIEF]
--
(6, 2, 'Panadol Pain Relief Tablets', '4.20','panadol.jpg','Paracetamol should taken seriously, very little to none when you need it for your headaches / other pain reliefs, if you take more than instructed there could be a chance of toxicity levels increasing leading to symptoms, if you experience this contact your local Doctor/GP','Each film-coated tablet contains: Paracetamol 500mg, it also contains: E219,E215,E217','This medication can have side-effects, like all medicines, although these are usually mild and do not affect everyone.'),
...
--
-- DATA [NICOTINE REPLACEMENT]
--
(11, 3, 'Nicotinell Cool Mint 4mg Chewing Gum [96 Pieces]', '28.50','nicotinell.jpg','This chewing gum that contains nicotine will help you quit smoking as it can easily ease down withdrawl symptoms from smoking. It has a refreshing flavour cool mint and it is sugar free! Just your ordinary gum to a normal person but to help you ease down.','Contains: Nicotine | Either 2mg -> 4mg in it.','This medication can have side-effects, like all medicines, although these are usually mild and do not affect everyone.'),
(12, 3, 'Nicorette 15mg Inhaler Nicotine Cartridges [4 Pieces]', '6.30','nico.jpg','The Nicorette 15mg Inhaler is an aid to help smokers give up cigarettes. This [NRT] Nicotine Replacement Therapy, helps to relieve withdrawl symptoms & cravings associated with intaking nicotine.','Contains: 1 Inhalator & 20 Nicotine Inhalation Cartridges || Menthol & 15mg Nicotine','This medication can have side-effects, like all medicines, although these are usually mild and do not affect everyone.'),
(13, 3, 'Nicorette Freshfruit Chewing Gum 4mg [105 pieces]', '36.00','fresh.jpg','Nicorette Chewing Gum is an aid to help smokers give up. This Nicotine Replacement Therapy [NRT] helps to relieve withdrawl symptoms and cravings associated with stopping in intake of nicotine.','Contains: 4mg Of Nicotine','This medication can have side-effects, like all medicines, although these are usually mild and do not affect everyone.');
(14, 3, 'NiQuitin Mini 1.5mg Mint Nicotine Lozenges [60 Pieces]', '13.99','niQ.jpg','NiQuiting Mini Lozenges are a handy and easy way to use Nicotine Lozenge to help you stop smoking or to cut down.','Contains: 1.5mg Nicotine','This medication can have side-effects, like all medicines, although these are usually mild and do not affect everyone.');
...
-- DATA [FIRST AID]
--
(31, 7, 'Sanitizante Antibacterial Sensitive Hand Sanitizer 65ml', '6.99','sanitizante.jpg','Sanitizante Hand Sanitiser Antibacterial Gel is a convenient way to disinfect your hands when out and about.  Simply apply onto hands and rub in, leaving no need to rinse. It is perfect for use, even on sensitive skin,  when soap and water are not available.  ','Contains: 99.9% alcohol','This medication can have side-effects, like all medicines, although these are usually mild and do not affect everyone.');
...
(39, 8, 'Levothyroxine', '79.99','levothyroxine.jpg','Levothyroxine is a medicine used to treat an underactive thyroid gland (hypothyroidism). The thyroid gland makes thyroid hormones which help to control energy levels and growth. Levothyroxine is taken to replace the missing thyroid hormone thyroxine. Levothyroxine is only available on prescription','Contains: Colloidal silicon dioxide, lactose, magnesium stearate, microcrystalline cellulose, corn starch, acacia and sodium starch glycolate, D&C Yellow No. 10 Aluminum Lake, FD&C Yellow No. 6 Aluminum Lake.','weight gain or loss  | headache | vomiting | diarrhea | changes in appetite | fever | changes in menstrual cycle | sensitivity to heat');
